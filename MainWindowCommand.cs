...
namespace ClassOutline
{
    ...
    internal sealed class MainWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("0839aa3b-8e7b-4d88-852b-d93e72cccf4d");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(ClassOutline2022), 0, true, this.package.DisposalToken);
